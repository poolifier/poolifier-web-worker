...
* reenable tasks stealing under back pressure by default ([a944273](https://github.com/poolifier/poolifier-web-worker/commit/a9442739a14027a2668e7d433bb8e3ca6db813b2))


### 🐞 Bug Fixes

* protect worker node tasks queue from concurrent tasks stealing ([dd85b2d](https://github.com/poolifier/poolifier-web-worker/commit/dd85b2d896674f5dc9572abca19fb6656f45442d))


### ⚡ Performance

* do mapExecute() args sanity checks once ([633afa3](https://github.com/poolifier/poolifier-web-worker/commit/633afa3d465f14b6e64f10ec49f9f77717c58f8d))
