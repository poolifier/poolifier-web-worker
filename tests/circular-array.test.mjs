...
import { CircularArray, DEFAULT_CIRCULAR_ARRAY_SIZE } from '../lib/index.js'

describe('Circular array test suite', () => {
  test('Verify that circular array can be instantiated', () => {
    const circularArray = new CircularArray()
    expect(circularArray).toBeInstanceOf(CircularArray)
  })

  test('Verify circular array default size at instance creation', () => {
    const circularArray = new CircularArray()
    expect(circularArray.size).toBe(DEFAULT_CIRCULAR_ARRAY_SIZE)
  })

  test('Verify that circular array size can be set at instance creation', () => {
    const circularArray = new CircularArray(1000)
    expect(circularArray.size).toBe(1000)
  })

  test('Verify that circular array size and items can be set at instance creation', () => {
  ...
  test('Verify that circular array size is valid at instance creation', () => {
  ...
  test('Verify that circular array empty works as intended', () => {
    const circularArray = new CircularArray()
    expect(circularArray.empty()).toBe(true)
  })

  test('Verify that circular array full works as intended', () => {
    const circularArray = new CircularArray(5, 1, 2, 3, 4, 5)
    expect(circularArray.full()).toBe(true)
  })

  test('Verify that circular array push works as intended', () => {
  ...
  test('Verify that circular array splice works as intended', () => {
    let circularArray = new CircularArray(1000, 1, 2, 3, 4, 5)
  ...
  test('Verify that circular array concat works as intended', () => {
  ...
  test('Verify that circular array unshift works as intended', () => {
    let circularArray = new CircularArray(5, 1, 2, 3, 4, 5)
  ...
  test('Verify that circular array resize works as intended', () => {
