...
Deno.test('Circular array test suite', async (t) => {
  ...
  await t.step(
    'Verify circular array default size at instance creation',
    () => {
      const circularArray = new CircularArray()
  ...
  await t.step(
    'Verify that circular array size can be set at instance creation',
    () => {
  ...
  await t.step(
    'Verify that circular array size and items can be set at instance creation',
    () => {
  ...
  await t.step(
    'Verify that circular array size is valid at instance creation',
    () => {
      expect(() => new CircularArray(0.25)).toThrow(
        new TypeError(
          'Invalid circular array size: 0.25 is not a safe integer',
        ),
      )
  ...
  await t.step('Verify that circular array empty works as intended', () => {
    const circularArray = new CircularArray()
    expect(circularArray.empty()).toBe(true)
  })

  await t.step('Verify that circular array full works as intended', () => {
    const circularArray = new CircularArray(5, 1, 2, 3, 4, 5)
    expect(circularArray.full()).toBe(true)
  })

  await t.step('Verify that circular array push works as intended', () => {
  ...
  await t.step('Verify that circular array splice works as intended', () => {
    let circularArray = new CircularArray(1000, 1, 2, 3, 4, 5)
  ...
  await t.step('Verify that circular array concat works as intended', () => {
  ...
  await t.step('Verify that circular array unshift works as intended', () => {
    let circularArray = new CircularArray(5, 1, 2, 3, 4, 5)
  ...
  await t.step('Verify that circular array resize works as intended', () => {
    ...
    expect(() => new CircularArray().resize(Number.MAX_SAFE_INTEGER + 1))
      .toThrow(
        new TypeError(
          `Invalid circular array size: ${
            Number.MAX_SAFE_INTEGER + 1
