...
```js
<script type="module">import { ThreadWorker } from 'https://cdn.jsdelivr.net/npm/poolifier-web-worker@0.3.9/browser/mod.js'</script>
```
...
import {
  DynamicThreadPool,
  FixedThreadPool,
} from 'https://cdn.jsdelivr.net/npm/poolifier-web-worker@0.3.9/browser/mod.js'
</script>
```
