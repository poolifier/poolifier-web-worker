...
```js
<script type="module">import { ThreadWorker } from 'https://cdn.jsdelivr.net/npm/poolifier-web-worker@0.6.0/browser/mod.js'</script>
```
...
import {
  ...
  FixedThreadPool,
  PoolEvents,
} from 'https://cdn.jsdelivr.net/npm/poolifier-web-worker@0.6.0/browser/mod.js'
</script>
```
