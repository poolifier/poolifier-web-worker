...
> {
   ...
   * @throws {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RangeError} If the maximum consecutive worker choice strategy executions has been reached.
   */
